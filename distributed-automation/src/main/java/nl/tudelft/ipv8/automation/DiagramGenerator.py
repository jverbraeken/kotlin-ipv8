...
pdf2 = pd.read_csv("/home/joost/Downloads/evaluations/parsed - evaluation-simulated-2021-01-25_21.22.53.csv")
...
diagram_names = [
    ...
    "MNIST - 50 nodes",
    "MNIST - 250 nodes",
    "MNIST - 50 nodes + 20 noise attackers",
    "MNIST - 50 nodes + 20 label-flip attackers",
    "MNIST - 50 nodes + 20 Fang (2020) KRUM attackers",
    "MNIST - 50 nodes + 20 Fang (2020) Trimmed Mean attackers",
    "MNIST - 50 nodes + 15 noise attacker",
    "MNIST - 50 nodes + 20 noise attackers",
    "MNIST - 50 nodes + 35 noise attackers",
]
